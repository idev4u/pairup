TODO: Checkout the fork from https://github.com/eirini-forks/pairup
...
in the meantime the default Firebase db is "Cloud Firestore" but in this case we need a Realtime Database.
Which hade to create first. Second you have to add the database.rules like the following once.
...
Don't forget to add the app sdk config to `src/conf.js`
